...
# 2184 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\include\\pic_as_chip_select.inc" 3
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\include\\proc\\pic16f628a.inc" 1 3
# 48 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\include\\proc\\pic16f628a.inc" 3
INDF equ 0000h
...
# 1064 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\include\\proc\\pic16f628a.inc" 3
...
# 2184 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\include\\pic_as_chip_select.inc" 2 3
...
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\include\\legacy\\as16f62xa_legacy.h" 1 3
...
; CONFIG
  CONFIG FOSC = INTOSCIO ; Oscillator Selection bits (INTOSC oscillator: I/O function on PORTA, 6/OSC2/CLKOUT pin, I/O function on PORTA, 7/OSC1/CLKIN)
  CONFIG WDTE = OFF ; Watchdog Timer Enable bit (WDT disabled)
  CONFIG PWRTE = OFF ; Power-up Timer Enable bit (PWRT disabled)
  CONFIG MCLRE = OFF ; PORTA, 5/MCLR/VPP Pin Function Select bit (PORTA, 5/MCLR/VPP pin function is digital input, MCLR internally tied to VDD)
  CONFIG BOREN = OFF ; Brown-out Detect Enable bit (BOD disabled)
  CONFIG LVP = ON ; Low-Voltage Programming Enable bit (PORTB, 4/PGM pin has PGM function, low-voltage programming enabled)
...
main:
    ...
    CLRF ((PORTA) and 07Fh);cuando se quiera modificar
    MOVLW 0x07 ;el valor del registro
    MOVWF ((CMCON) and 07Fh)
    BANKSEL (TRISA)
    MOVLW 0x10
    ...
    CLRF ((PORTA) and 07Fh)
    MOVLW 0x00
    MOVWF ((PORTA) and 07Fh)

START:
    BANKSEL (TRISB)
    BSF TRISB,3
    BANKSEL (CCP1CON)
    CLRF ((CCP1CON) and 07Fh) ;REINICIAR
    MOVLW 00000100B
    MOVWF ((CCP1CON) and 07Fh) ;PIR1, 2(PIR1,2)
    BANKSEL (T1CON)
    CLRF ((T1CON) and 07Fh)
    MOVLW 00110000B;PRES=8,OSC=OFF,CLOCK INTERNAL
    MOVWF ((T1CON) and 07Fh)
    BCF T1CON,0
    NOP
    NOP
    BSF T1CON,0
